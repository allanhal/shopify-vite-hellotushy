...
See the [vite-shopify-example](https://github.com/allanhal/allanhal-shopify/tree/main/examples/vite-shopify-example) theme for a basic demonstration of `vite-plugin-shopify` usage.
